...
options("golem.app.prod" = TRUE, shiny.port = 8080,
        auth0_config_file = system.file("app/_auth0.yml", package = "PortalDapes"))

devtools::load_all("PortalDapes/int/app/_auth0.yml")

auth0::shinyAppAuth0(PortalDapes:::app_ui(), PortalDapes:::app_server)
